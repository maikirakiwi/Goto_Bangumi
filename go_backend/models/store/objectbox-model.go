...
func ObjectBoxModel() *objectbox.Model {
	...
	model.RegisterBinding(BangumiBinding)
	model.RegisterBinding(ConfigModelBinding)
	model.RegisterBinding(CacheBinding)
	model.RegisterBinding(UserBinding)
	model.LastEntityId(4, 5924075746120306429)
	model.LastIndexId(1, 3015471243652167874)
